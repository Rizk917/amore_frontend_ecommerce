        ...
        <div className="container-home">
          ...
          <div className="listing fixing">
            {popular.map((populars, key) => {
              return (
                <CardComp
                  productName={populars.productId.productName}
                  productPrice={populars.productId.productPrice}
                  FinalPrice={populars.productId.FinalPrice}
                  productImage={populars.productId.productImage}
                  productDescription={populars.productId.productDescription}
                  _id={populars.productId._id}
                />
              );
            })}
          </div>
